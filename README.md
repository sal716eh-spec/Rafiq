...
| `salah-data.js` | "Your salah" data (generated by `tools/salah/build.py`; awaiting teacher review, not shown in the app yet; review sheet: `tools/salah/REVIEW.md`) |
| `essentials-data.js`, `essentials.js` | Practise → Everyday essentials: numbers, days, Islamic and Western months, colours, telling the time (table + drill) |
