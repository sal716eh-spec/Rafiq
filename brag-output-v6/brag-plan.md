# Brag Plan v6: Rafiq (رَفِيق) — the story
...
## v6 voices (as approved)
Narrator: lines 1-3, 5-7, 9-11. Rafiq (the app's native Arabic voice): 4 "Meet رَفِيق…", 8 "رَفِيق remembers…", 12 "Try رَفِيق free today." — Rafiq speaks only when he says his own name.
